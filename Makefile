...
CFLAGS=-Wall -O0 -g -I ${LIBEVENT_DIR}/include
...
rum: rum.o socket.o default_callback.o mysql_callback.o postgresql_callback.o stats_callback.o mysql_cdb.o postgresql_cdb.o mysql_mitm.o postgresql_mitm.o parse_arg.o mysql_password/sha1.o mysql_password.o
	$(CC) $(LDFLAGS) rum.o socket.o default_callback.o mysql_callback.o postgresql_callback.o stats_callback.o mysql_cdb.o postgresql_cdb.o mysql_mitm.o postgresql_mitm.o mysql_password/sha1.o mysql_password.o parse_arg.o $(LDLIBS) -o rum
	#strip rum
