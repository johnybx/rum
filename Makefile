...
LIBEVENT_DIR=libevent-2.0.20-stable

LDFLAGS=-L ${LIBEVENT_DIR}/.libs -levent_core -lrt -lcdb -lm
CFLAGS=-Wall -g -I ${LIBEVENT_DIR}/include -g 
#CFLAGS=-Wall -g -I ${LIBEVENT_DIR}/include -g
...
${LIBEVENT_DIR}/.libs/libevent.a:
	...
	-$(shell echo 'cd $(LIBEVENT_DIR); CFLAGS="-g" ./configure --disable-shared --enable-static; make clean; make' >&2)
	-$(shell cd $(LIBEVENT_DIR); CFLAGS="-g" ./configure --disable-shared --enable-static; make clean; make)
