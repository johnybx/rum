...
void
stats_write_callback (struct bufferevent *bev, void *ptr)
{
...
void
stats_event_callback (struct bufferevent *bev, short events, void *ptr)
{
    struct bev_arg *bev_arg = ptr;
...
void
send_stats_to_client (struct bufferevent *bev)
{
